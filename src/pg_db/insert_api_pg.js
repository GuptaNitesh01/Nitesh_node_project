async function main(req,res){
    ...
    const result= await client.query('insert into email_stats(email_response_id,mail_from,mail_to,subject,message)  values($1,$2,$3,$4,$5,$6)', [email_response_id,mailFrom,mailTo,mailSubject,mailMessage]
